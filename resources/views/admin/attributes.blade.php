                            ...
                            <div class="row g-4">
                                <div class="col-sm-auto">
                                    <div>
                                        <!-- Horizontal Collapse -->
                                        <div class="mb-3">
                                            <button class="btn btn-secondary" type="button" data-bs-toggle="collapse" data-bs-target="#collapseWidthExample" aria-expanded="true" aria-controls="collapseWidthExample">
                                                ...
                                                <div class="card card-body mb-0" style="width: 300px;">
                                                    <div>
                                                        <form action="{{route('attributes.store')}}" method="post">
                                                            ...
                                                            <select id="selectAttribute" name="selectAttribute" class="form-select mb-3" aria-label="Default select example">
                                                                <option selected>Open this select menu</option>
                                                                <option value="text">Text</option>
                                                                <option value="image">Image</option>
                                                                <option value="color">Color</option>
                                                            </select>
                                                            <button type="submit" class="btn btn-success bg-gradient waves-effect waves-light">Success</button>
                                                        </form>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                            <li>
                                                                ...
                                                                <!-- Horizontal Collapse -->
                                                                <!-- Grids in modals -->
                                                                <button type="button" class="btn dropdown-item" data-bs-toggle="modal" data-bs-target="#{{$attribute->name}}">
                                                                    Edit
                                                                </button>
                                                                
                                                            </li>
                                                            <li >
                                                                <form id="deleteForm-{{$attribute->id}}" action="{{ route('attributes.destroy',$attribute->id)}}" method="post">
                                                                    @csrf
                                                                    @method('delete')
                                                                    {{-- <a class="btn dropdown-item" href="{{ route('attributes.destroy')}}">Delete</a> --}}
                                                                </form>
                                                                <button  class="btn dropdown-item" onclick="confirmDelete({{$attribute->id}})">Delete</button> 
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </td>
                                            </tr>
                                            <div class="modal fade" id="{{$attribute->name}}" tabindex="-1" aria-labelledby="id?{{$attribute->id}}" aria-modal="true">
                                                                ...
                                                                <div class="row g-3">
                                                                    <div class="col-xxl-6">
                                                                        <div>
                                                                            ...
                                                                            <input type="text" class="form-control" id="firstName" name="updateAttribute" value="{{$attribute->name}}">
                                                                        </div>
                                                                    </div><!--end col-->
                                                                    <div class="col-xxl-6">
                                                                        <div>
