        ...
        <div class="container">
            ...
            <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control format-currency @error('price') is-invalid @enderror"
                        id="price_display" autocomplete="off" value="{{ old('price', 0) }}">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control format-currency @error('sell_price') is-invalid @enderror"
                        id="sell_price_display" autocomplete="off" value="{{ old('sell_price', 0) }}">
                ...
                <div class="mb-3">
                    <label for="">Ảnh phụ (có thể chọn nhiều):</label>
