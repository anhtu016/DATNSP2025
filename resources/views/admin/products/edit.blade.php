            ...
            <div class="container">
                ...
                <form action="{{ route('products.update', $product->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <img src="{{ asset('storage/' . $product->thumbnail) }}" width="100" alt="Ảnh hiện tại"><br>

                        @if ($product->images->count() > 0)
                            <label>Ảnh phụ hiện tại</label><br>
                            @foreach ($product->images as $image)
                                <img src="{{ asset('storage/' . $image->image) }}" width="100" alt="Ảnh phụ">
                            @endforeach
                        @endif
                    </div>
                    ...
                    <div class="form-group">
                        <label>Thêm ảnh phụ mới (nếu muốn thêm)</label>
