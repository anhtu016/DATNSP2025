        ...
        <div class="row">
            <div class="col-lg-9">
                <div class="singlepost">
                    <figure><img alt="" class="img-fluid" src="client/img/blog-single.jpg"></figure>
                ...
                <div id="comments">
                    ...
                    <ul>
                        <li>
                            <div class="avatar">
                                <a href="#"><img src="client/img/avatar1.jpg" alt="">
                                </a>
                            </div>
                            ...
                            <ul class="replied-to">
                                <li>
                                    <div class="avatar">
                                        <a href="#"><img src="client/img/avatar2.jpg" alt="">
                                        </a>
                                    </div>
                                    <div class="comment_right clearfix">
                                        <div class="comment_info">
                        ...
                        <li>
                            <div class="avatar">
                                <a href="#"><img src="client/img/avatar3.jpg" alt="">
                                </a>
                            </div>
