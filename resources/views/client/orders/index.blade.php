...
@section('content')
    ...
    <div class="cart-table-container">
        <h2 class="mb-4">📋 Lịch sử đơn hàng của bạn <small class="text-muted">({{ \Carbon\Carbon::now()->format('d/m/Y') }})</small></h2>
                        ...
                        <tr>
                            ...
                            <td class="btn-group">
                                ...
                                @if ($order->order_status == 'delivered')
                                    <a href="{{ route('orders.review', $order->id) }}" class="btn btn-warning">Đánh giá</a>
                                @endif
                            </td>
                        </tr>
                    @empty
