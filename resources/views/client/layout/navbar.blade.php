        ...
        <div class="container">
            <div class="row small-gutters">
                <div class="col-xl-3 col-lg-3 d-lg-flex align-items-center">
                    <div id="logo">
                        <a href="{{ route('homeadmin') }}"><img src="{{ asset('client/img/logo_black.svg') }}"
                ...
                <nav class="col-xl-6 col-lg-7">
                    ...
                    <div class="main-menu">
                        <div id="header_menu">
                            <a href="{{ route('home') }}"><img src="{{ asset('client/img/logo_black.svg') }}"
                                    alt="" width="100" height="35"></a>
                                            ...
                                            @if ($category->children->isNotEmpty())
                                                <ul>
                                                    @foreach ($category->children as $child)
                                                        <li>
                                                            <a
                                                                href="{{ route('categories.products', $child->slug) }}">{{ $child->name }}</a>
                                                            @if ($child->children->isNotEmpty())
                                                                <ul>
                                                                    @foreach ($child->children as $grandchild)
                                                                        <li>
                                                                            <a
                                                                                href="{{ route('categories.products', $grandchild->slug) }}">{{ $grandchild->name }}</a>
                                                                        </li>
                                                                    @endforeach
                                                                </ul>
                                                            @endif
                                ...
                                @if (Auth::check())
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="user">
                                        ...
                                        <li><a class="dropdown-item" href="{{ route('user.orders.index') }}"><i
                                                    class="ti-user"></i> Theo dõi đơn hàng</a></li>
                                        <li>
                                        ...
                                        <li>
                                            <form action="{{ route('logout') }}" method="POST">
                                                ...
                                                <button type="submit" class="dropdown-item text-danger"><i
                                                        class="ti-power-off"></i> Đăng xuất</button>
                                            </form>
                                        </li>
                                    </ul>
                                @else
                        ...
                        <a href="{{ route('cart.view') }}" class="text-dark" style="font-size: 20px;">
                            <div style="position: relative; display: inline-block;">
                                ...
                                @php
                                    ...
                                    $cartCount = count($cart); // đếm theo số loại sản phẩm khác nhau
                                @endphp
