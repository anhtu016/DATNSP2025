...
public function viewCart()
{
    ...
    // ✅ Lấy sản phẩm liên quan (tối đa 6 sản phẩm từ cùng danh mục)

        $productIds = collect($cart)->pluck('product_id');

$relatedProducts = \App\Models\Product::whereNotIn('id', $productIds)
    ->inRandomOrder()
    ->take(6)
    ->get();
    return view('client.cart', compact('cart', 'coupons', 'hasValidCoupon', 'relatedProducts'));
}
